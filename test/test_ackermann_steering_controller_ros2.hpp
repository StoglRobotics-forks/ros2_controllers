...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ACKERMANN_STEERING_CONTROLLER_ROS2_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ACKERMANN_STEERING_CONTROLLER_ROS2_HPP_
...
class TestableAckermannSteeringControllerRos2 : public ros2_ackermann_cont::AckermannSteeringControllerRos2
{
  FRIEND_TEST(AckermannSteeringControllerRos2Test, all_parameters_set_configure_success);
  FRIEND_TEST(AckermannSteeringControllerRos2Test, check_exported_intefaces);
  FRIEND_TEST(AckermannSteeringControllerRos2Test, activate_success);
...
public:
    ...
    const rclcpp_lifecycle::State & previous_state) override
  {
    ...
    return ros2_ackermann_cont::AckermannSteeringControllerRos2::on_activate(previous_state);
  }
...
class AckermannSteeringControllerRos2Fixture : public ::testing::Test
{
public:
...
protected:
  void SetUpController(const std::string controller_name = "test_ackermann_steering_controller_ros2")
  {
