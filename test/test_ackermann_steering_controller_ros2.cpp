...
TEST_F(AckermannSteeringControllerRos2Test, check_exported_intefaces)
{
  ...
  EXPECT_EQ(command_intefaces.names[0], controller_->params_.rear_wheel_name + "/" + hardware_interface::HW_IF_POSITION);
  EXPECT_EQ(command_intefaces.names[1], controller_->params_.rear_wheel_name + "/" + hardware_interface::HW_IF_POSITION);
  ...
  EXPECT_EQ(state_intefaces.names[1], controller_->params_.rear_wheel_name + "/" + hardware_interface::HW_IF_POSITION);


  // // check ref itfs 
  // auto reference_interfaces = controller_->export_reference_interfaces();
  // ASSERT_EQ(reference_interfaces.size(), CMD_MY_ITFS);
...
TEST_F(AckermannSteeringControllerRos2Test, activate_success)
{
  ...
  // EXPECT_EQ(controller_->reference_interfaces_.size(), CMD_MY_ITFS);
...
TEST_F(AckermannSteeringControllerRos2Test, reactivate_success)
{
  ...
  ASSERT_EQ(controller_->on_configure(rclcpp_lifecycle::State()), NODE_SUCCESS);
  ASSERT_EQ(controller_->on_activate(rclcpp_lifecycle::State()), NODE_SUCCESS);
  ASSERT_EQ(controller_->command_interfaces_[CMD_MY_ITFS-2].get_value(), 101.101);
  ASSERT_EQ(controller_->on_deactivate(rclcpp_lifecycle::State()), NODE_SUCCESS);
...
//  hereTEST_F(AckermannSteeringControllerRos2Test, publish_status_success)
// {
//   SetUpController();
...
// }
 ...
 // hereTEST_F(AckermannSteeringControllerRos2Test, receive_message_and_publish_updated_status)
// {
//   SetUpController();
//   rclcpp::executors::MultiThreadedExecutor executor;
//   executor.add_node(controller_->get_node()->get_node_base_interface());
...
//hre  TEST_F(AckermannSteeringControllerRos2Test, test_message_timeout)
// {
//   SetUpController();
//   rclcpp::executors::MultiThreadedExecutor executor;
//   executor.add_node(controller_->get_node()->get_node_base_interface());
...
// here TEST_F(AckermannSteeringControllerRos2Test, test_ref_timeout_zero_for_update)
// {
//   SetUpController();
//   rclcpp::executors::MultiThreadedExecutor executor;
//   executor.add_node(controller_->get_node()->get_node_base_interface());
...
//here  TEST_F(AckermannSteeringControllerRos2Test, test_ref_timeout_zero_for_reference_callback)
// {
//   SetUpController();
//   rclcpp::executors::MultiThreadedExecutor executor;
//   executor.add_node(controller_->get_node()->get_node_base_interface());
