...
protected:
  ...
  std::shared_ptr<hardware_interface::StateInterface> imu_orientation_x_ =
    std::make_shared<hardware_interface::StateInterface>(
      sensor_name_, "orientation.x", &sensor_values_[0]);
  std::shared_ptr<hardware_interface::StateInterface> imu_orientation_y_ =
    std::make_shared<hardware_interface::StateInterface>(
      sensor_name_, "orientation.y", &sensor_values_[1]);
  std::shared_ptr<hardware_interface::StateInterface> imu_orientation_z_ =
    std::make_shared<hardware_interface::StateInterface>(
      sensor_name_, "orientation.z", &sensor_values_[2]);
  std::shared_ptr<hardware_interface::StateInterface> imu_orientation_w_ =
    std::make_shared<hardware_interface::StateInterface>(
      sensor_name_, "orientation.w", &sensor_values_[3]);
  std::shared_ptr<hardware_interface::StateInterface> imu_angular_velocity_x_ =
    std::make_shared<hardware_interface::StateInterface>(
      sensor_name_, "angular_velocity.x", &sensor_values_[4]);
  std::shared_ptr<hardware_interface::StateInterface> imu_angular_velocity_y_ =
    std::make_shared<hardware_interface::StateInterface>(
      sensor_name_, "angular_velocity.y", &sensor_values_[5]);
  std::shared_ptr<hardware_interface::StateInterface> imu_angular_velocity_z_ =
    std::make_shared<hardware_interface::StateInterface>(
      sensor_name_, "angular_velocity.z", &sensor_values_[6]);
  std::shared_ptr<hardware_interface::StateInterface> imu_linear_acceleration_x_ =
    std::make_shared<hardware_interface::StateInterface>(
      sensor_name_, "linear_acceleration.x", &sensor_values_[7]);
  std::shared_ptr<hardware_interface::StateInterface> imu_linear_acceleration_y_ =
    std::make_shared<hardware_interface::StateInterface>(
      sensor_name_, "linear_acceleration.y", &sensor_values_[8]);
  std::shared_ptr<hardware_interface::StateInterface> imu_linear_acceleration_z_ =
    std::make_shared<hardware_interface::StateInterface>(
